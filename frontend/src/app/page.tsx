...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center bg-gradient-to-bl from-slate-100 via-slate-300 to-slate-500">
      <span className="text-8xl font-bold text-center">Welcome to Gira</span>
      <span className="text-3xl font-semibold text-black/70 text-center">Your next best Agile task Manager</span>
